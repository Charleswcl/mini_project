package ibf2022batch03_miniproject.customer_invoice_manager.report;
    ...
    private InputStreamResource generateReport() {
        try (ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            for(Customer customer: customers) {
                ...
                row.createCell(7).setCellValue(DateFormatUtils.format(customer.getCreatedAt(), DATE_FORMATTER));
            }
            workbook.write(out);
