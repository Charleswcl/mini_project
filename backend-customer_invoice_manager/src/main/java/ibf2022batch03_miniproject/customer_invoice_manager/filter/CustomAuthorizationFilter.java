package ibf2022batch03_miniproject.customer_invoice_manager.filter;
...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
    ...
    private static final String[] PUBLIC_ROUTES = { "/api/user/new/password", "/api/user/login", "/api/user/verify/code",
            "/api/user/register", "/api/user/refresh/token", "/api/user/image", "api/customer/**" };
